...
function denyWager(message){verdictView.textContent=message;wagerInput.classList.remove('rl-deny-b9a0eb4e');void wagerInput.offsetWidth;wagerInput.classList.add('rl-deny-b9a0eb4e');}
...
var brandEl=document.querySelector('.rl-brand-b9a0eb4e');var echoEl=grab('rl-echo');if(brandEl&&echoEl){echoEl.textContent=brandEl.textContent.replace(/\s+/g,' ').trim();}
